            ...
            foreach ($v as $k0 => $v0) {
                if ($k0 == 'state-from') {
                    ...
                    foreach ($array_states[$state_from] as $k1 => $v1) {
                        if (in_array($prefix . $k1, $array_headers) == false)
                            array_push($array_headers, $prefix . $k1); //add new header
                ...
                if (($k0 != 'state-from') and ($k0 != 'state-to')) {
                    $prefix = 'State::';
                    if (in_array($prefix . $k0, $array_headers) == false)
                        array_push($array_headers, $prefix . $k0); //add new header
