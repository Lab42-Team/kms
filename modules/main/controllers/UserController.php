...
class UserController extends Controller
{
        ...
        if (Yii::$app->request->post()) {
            ...
            if ($model->save()) {
                ...
                Yii::$app->getSession()->setFlash('success',
                    Yii::t('app', 'USERS_PAGE_MESSAGE_ADD_NEW_USER'));
    ...
    public function actionUpdate($id)
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            ...
            Yii::$app->getSession()->setFlash('success',
                Yii::t('app', 'USERS_PAGE_MESSAGE_UPDATED_USER_INFORMATION'));
    ...
    public function actionDelete($id)
    {
        ...
        if (Yii::$app->user->getId() == $id) {
            Yii::$app->getSession()->setFlash('warning',
                Yii::t('app', 'USERS_PAGE_MESSAGE_NOT_DELETE_USER'));
        } else {
            $this->findModel($id)->delete();
            // Вывод сообщения об успешном удалении пользователя
            Yii::$app->getSession()->setFlash('success',
                Yii::t('app', 'USERS_PAGE_MESSAGE_DELETED_USER'));
        }
    ...
    public function actionUpdateProfile($id)
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            // Вывод сообщения об успешном удалении пользователя
            Yii::$app->getSession()->setFlash('success',
                Yii::t('app', 'USERS_PAGE_MESSAGE_UPDATED_YOUR_ACCOUNT_INFORMATION'));
    ...
    public function actionChangePassword($id)
    {
        ...
        if (Yii::$app->request->post()) {
            ...
            if ($model->validate()) {
                ...
                Yii::$app->getSession()->setFlash('success',
                    Yii::t('app', 'USERS_PAGE_MESSAGE_UPDATED_YOUR_PASSWORD'));
