    ...
    'components' => [
        ...
        'urlManager' => [
            ...
            'rules' => [
                ...
                '/state-transition-diagrams/<_std:(edit-state|delete-state|add-state-property|edit-state-property|delete-state-property|add-transition|edit-transition|delete-transition|save-indent)>' =>
                    'stde/state-transition-diagrams/<_std>',
            ],
        ],
        'cache' => [
